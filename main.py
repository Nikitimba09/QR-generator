...
def selected():
    ...
    qrcode_data.place(x=50, y=340)

    link_button = Button(frame2, text="Перейти по ссылке", bg='#48DD00', fg='black', font=('ariel 10 bold'),
                         command=lambda: webbrowser.open(data))
    link_button.place(x=50, y=380)


data_label = Label(frame1, text='Enter link:', font=('arial 15 bold'), bg='white')
